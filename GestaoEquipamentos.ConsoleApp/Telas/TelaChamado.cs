...
namespace GestaoEquipamentos.ConsoleApp.Telas
{
    public class TelaChamado : TelaBase
    {
        ...
        public TelaChamado(TelaEquipamento telaEqui, ControladorChamado controlador, TelaSolicitante telaSol)
            : base("Cadastro de Chamados")
        {
            telaEquipamento = telaEqui;
        ...
        public override void VisualizarRegistros()
        {
            ...
            {
                Console.WriteLine("{0,-10} | {1,-25} | {2,-25} | {3,-25} | {4,-25}",
        ...
        private static void MontarCabecalhoTabela()
        {
            ...
            Console.WriteLine("{0,-10} | {1,-25} | {2,-25} | {3,-25} | {4,-25}", "Id", "Equipamento", "Título", "Dias em Aberto", "Solicitante");
